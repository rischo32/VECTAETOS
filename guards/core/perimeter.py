...
class PerimeterCoordinates:
    ...
    def __post_init__(self) -> None:
        ...
        if normalized_scope != expected_scope:
            # Level 1 is allowed to protect specialized ontology while still
            # sharing vocabulary-like scan mechanics. Other level/scope
            # mismatches should be explicit and reviewed before callers create
            # coordinates.
            if normalized_level != PerimeterLevel.LEVEL_1:
                raise ValueError(
