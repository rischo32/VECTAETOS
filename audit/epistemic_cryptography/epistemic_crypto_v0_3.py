...
# ------------------------------------------------------------
# CONFIG (descriptive only)
# ------------------------------------------------------------

DELTA = 0.3  # descriptive threshold (no decision authority)
